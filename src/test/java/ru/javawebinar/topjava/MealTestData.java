...
public class MealTestData {
    public static final MatcherFactory<Meal> MATCHER = MatcherFactory.usingIgnoringFieldsComparator(Meal.class, "user", "excess");
    public static final MatcherFactory<MealTo> MEAL_TO_MATCHER = MatcherFactory.usingIgnoringFieldsComparator(MealTo.class, "user", "excess");
    ...
    public static final List<MealTo> mealsTo = List.of(new MealTo(meal7, true), new MealTo(meal6, true),
            new MealTo(meal5, true), new MealTo(meal4, true), new MealTo(meal3, false),
            new MealTo(meal2, false), new MealTo(meal1, false));
