...
public class MealTestData {
    ...
    public static final MatcherFactory<Meal> STRONG_MATCHER = MatcherFactory.usingIgnoringFieldsComparator("user.registered", "user.meals");
    ...
    public static final Meal adminMeal1WithUser = new Meal(adminMeal1, UserTestData.admin);
